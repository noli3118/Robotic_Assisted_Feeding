...
impl ObjectiveMaster {
    ...
    pub fn relaxed_ik(chain_lengths: &[usize]) -> Self {
        ...
        println!("\n\n HHHHHHHEEEEEEEEEEEEELLLLLLLLLLLOOOOOOOOOOO \n\n");
    ...
    pub fn HIRO_ik(chain_lengths: &[usize]) -> Self {
        ...
        // objectives.push(Box::new(MinimizeVelocity));   weight_priors.push(0.7); // 0.7
        // objectives.push(Box::new(MinimizeAcceleration));    weight_priors.push(0.5); // 0.5
        objectives.push(Box::new(MinimizeJerk));    weight_priors.push(0.3); // 0.3
    ...
    fn __call(&self, x: &[f64], vars: &RelaxedIKVars) -> f64 {
        ...
        for i in 0..self.objectives.len() {
            ...
            // println!("Weight: {}", self.weight_priors[i]);
            // println!("Objective Name: {}, ", self.objectives[i]);
        }
        // println!("----");
        out
    }
